...
def bot_vs(way1,way2,n):
	...
	print(str(way1.__class__.__name__)+' vs '+str(way2.__class__.__name__)+' : '+str(win_rate))
	return win_rate>0.5
def competition(way_list):
	...
	print('wins count:')
	print(count)
	print('The strongest way is '+str(way_list[np.argmax(count)].__class__.__name__))
	...
	while 1:
		...
		if choice==1:
			...
			if against.is_AI==1:
				...
				against.learning=1				
				print('You are playing against a AI,would you like to load a trained model?(0/1 to choose)')
				while 1:
					try:
						YN1=int(input())
					except:
					...
					if YN1==1:
						...
						try: 
							...
							print('load failed')
						if load_success==1:
							print('would you like the model to learn from you?(0/1 to choose)')
							while 1:
								try:
									YN2=int(input())
								except:
			...
			if against.is_AI:
				if against.learning==1:
					print('Would you like save the model after training by you?(0/1 to choose)')
					while 1:
						try:
							YN3=int(input())
						except:
						...
						if YN3==0:
							break
						if YN3==1:
							print('Please type the filename you want to save the model:')
							fn2=input()
							try:
								against.save(fn2)
							except:
